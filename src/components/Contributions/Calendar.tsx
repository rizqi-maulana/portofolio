    ...
    return (
        <>
            <div className='relative flex flex-col'>
                <ul className='flex justify-end md:gap-[3px] overflow-hidden text-xs text-neutral-400 md:justify-start'>
                    {months.map((month) => (
                        <li
                            key={month.firstDay}
                ...
                <div className='flex justify-start gap-[3px] md:overflow-hidden overflow-x-scroll'>
                    {weeks?.map((week) => (
