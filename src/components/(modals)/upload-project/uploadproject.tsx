...
export default function UploadProject({ closeModal }: any) {
    ...
    return (
        <div className="w-full h-[100vh] fixed flex items-center justify-center flex-col z-[1001] bg-[#0D0D18]/40 top-0" ref={outside}>
            ...
            <form onSubmit={HandleSubmit} className="px-5 py-3 rounded-[5px] bg-[#151527] w-[300px] animate__animated animate__bounceIn">
                <div>
                    ...
                    <div className="my-5 w-max mx-auto">
                        ...
                        <input type="file" name="" id="Image" accept="image/*" hidden onChange={handleImageUpload} required />
                    </div>
                    ...
                    <input autoComplete="off" placeholder="Project Title" type="text" id='Name' required className='w-full h-[35px] border-2 border-white rounded-[8px] mt-1 mb-2 bg-transparent text-[11px] px-2' onChange={(e) => setTitle(e.target.value)} />

                    <label htmlFor="Description" className="font-bold text-sm">Description:</label>
                    <input type="text" id='Description' autoComplete="off" placeholder="Description of Your Project" required className='w-full h-[35px] border-2 border-white rounded-[8px] mt-1 mb-2 bg-transparent text-[11px] px-2' onChange={(e) => setDescription(e.target.value)} />
                    ...
                    <input type="text" id='Website' autoComplete="off" placeholder="Website Link" className='w-full h-[35px] border-2 border-white rounded-[8px] mt-1 mb-2 bg-transparent text-[11px] px-2' onChange={(e) => setWebsite(e.target.value)} />
